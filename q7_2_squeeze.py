...
param_net = models.squeezenet1_1(pretrained=True)
params = param_net.state_dict()

params.pop('classifier.1.weight')
params.pop('classifier.1.bias')

net = models.squeezenet1_1(pretrained=False, num_classes=17)
...
'''
fc_input_num = net.classifier[1].in_features
net.classifier[1] = nn.Linear(fc_input_num, 17)
'''
...
torch.save(best_model, 'best_model_squeezenet.pth')
